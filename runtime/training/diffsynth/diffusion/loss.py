...
def _weight_three_contact_losses(
    ...
    active_base = (base_valid_count > 0).to(dtype=base_loss.dtype)
    active_e = (e_valid_count > 0).to(dtype=e_loss.dtype)
    active_mu = (mu_valid_count > 0).to(dtype=mu_loss.dtype)
